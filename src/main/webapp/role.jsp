		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<%=request.getContextPath() %>/project" class="waves-effect"><i class="fa fa-table fa-fw"
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="<%=request.getContextPath()%>/addRole" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="#" class="btn btn-sm btn-primary">Sửa</a> <a
												href="./deleteRole?id=<%=role.getId()%>" class="btn btn-sm btn-danger">Xóa</a></td>
										</tr>
